...
const Addtips = () => {
  ...
  const handleSubmit = e => {
    e.preventDefault();
    axios
      .post("http://localhost:3000/addTips", tips, {
        headers: {
          "x-auth-token": user,
    ...
    <div className="container" style={{width: "30%" }}>
      {message === null && submit === null ? (
        <div>
            ...
            <h3 className="d-flex justify-content-center p-2">Motivational Tips</h3>
              <Form.Group controlId="exampleForm.ControlTextarea1">
                <Form.Label> Today's Motivational Tip</Form.Label>
